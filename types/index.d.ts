...
interface DOMAttributes<T> {
    ...
    onsubmit?: null | false | EventHandler<T, Event & {
...
interface ContainerElementSVGAttributes<T> extends SVGAttributes<T>, Pick<PresentationSVGAttributes, 'clip-path' | 'mask' | 'cursor' | 'opacity' | 'filter' | 'enable-background' | 'color-interpolation' | 'color-rendering'> {
}
